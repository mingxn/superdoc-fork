<h1 align="center">superdoc-fork</h1>

> **Fork Notice**: This is a fork of [SuperDoc](https://github.com/Harbour-Enterprises/SuperDoc) by Harbour Enterprises.
> Modified on February 2025.
> Original project: https://github.com/Harbour-Enterprises/SuperDoc
>
> This fork is distributed under the same AGPL-3.0 license as the original.
...
```javascript
import 'superdoc-fork/style.css';
import { SuperDoc } from 'superdoc-fork';
